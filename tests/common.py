...
class FaisapayCommon(PaymentCommon):

    @classmethod
    def setUpClass(cls):
        super().setUpClass()

        cls.provider = cls._prepare_provider('faisapay', update_values={
            'faisapay_merchant_id': 'rzp_123',
            'faisapay_passcode': 'Y63AyP9eL91',
            'faisapay_acquirer_id': 'coincoin_motherducker',
        })
